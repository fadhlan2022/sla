...
while ($hasil = mysqli_fetch_array($query)) {
    $query_pic_hcsa = mysqli_query($konek, "SELECT pic_hcsa FROM master_project WHERE kode_project = '" . $hasil['kode_project'] . "'");
    $pic_hcsa_data = mysqli_fetch_array($query_pic_hcsa);
    $pic_hcsa = $pic_hcsa_data['pic_hcsa'];
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-horizontal" method="POST" action="proses_transaksi_existing_hcsa.php" autocomplete="off">
                    <div class="card-body">
                                      ...
                                      <div class="form-group">
                                          <div>
                                            <select id="next_user" name="next_user" class="selectpicker form-control" data-live-search="true" required>
                                                <option selected></option>
                                                <?php
                                                $query_user = "SELECT * FROM user WHERE nik = '$pic_user' OR nik = '$pic_itScrum' OR nik = '$pic_itGm' OR nik = '$pic_itDev' OR nik = '$pic_itQa' OR nik = '$pic_itRoll'";
