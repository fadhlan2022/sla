            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="card-header">
                    <h2 class="card-title kapital"> Master Departemen </h2>
                </div>
              </div>
              <!-- Tabel Master -->
                <div class="card-body table-responsive">
                    ...
                    <a class="btn btn-success btn-sm mt-2" href="tambah_data_departemen.php">
                    ...
                    <table id="example2" class="table table-striped projects mt-3">
                        ...
                        <tbody id="myTable">
                            ...
                            $query = mysqli_query($konek, "SELECT * FROM dept LIMIT $start, $limit");
                            
                            // Fetch total number of users for pagination
                            $total_rows = mysqli_num_rows(mysqli_query($konek, "SELECT * FROM dept"));
                            ...
                            while ($data = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data['kode_departemen']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['departemen']; ?>
                                    </td>
                                    <td class="project-actions text-center">
                                        <a class="btn btn-info btn-sm" href="edit_data_departemen.php?kode_departemen=<?php echo $data['kode_departemen']; ?>">
                                            <i class=" fas fa-pencil-alt">
                                            </i>
                                            Edit
                                        </a>
                                        <a class="btn btn-danger btn-sm" href="hapus_data_departemen.php?kode_departemen=<?php echo $data['kode_departemen']; ?>" onclick="return confirm('Anda yakin akan menghapus departemen <?php echo $data['departemen']; ?>?');">
